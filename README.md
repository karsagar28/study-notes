...
- Figures are standalone SVGs in `notes/img/`, generated by `tools/figures.py` — edit the Python, re-run it, refresh. Reference them from markdown as `![alt](notes/img/fig-x.svg)` (paths are relative to `index.html`, not the note).
